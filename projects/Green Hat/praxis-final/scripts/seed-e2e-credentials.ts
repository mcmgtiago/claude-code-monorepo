...
const USERS: Array<{
  ...
  { email: "e2e-admin@praxis.test", role: "admin", full_name: "E2E Admin" },
  { email: "e2e-manager@praxis.test", role: "manager", full_name: "E2E Manager" },
  { email: "e2e-agent@praxis.test", role: "agent", full_name: "E2E Agent" },
  { email: "e2e-viewer@praxis.test", role: "viewer", full_name: "E2E Viewer" },
];
