...
const schema = z.object({
  ...
  // Avello Gateway (primary AI provider for PRÁXIS)
  AVELLO_AUTH_TOKEN: z.string().optional().default(""),
  AVELLO_BASE_URL: z.string().optional().default("https://avellogateway.online"),
