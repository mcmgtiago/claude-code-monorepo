---
description: Executa UMA sessão do gov-loop do PRÁXIS (uma feature de governança, depois morre)
---
Execute o protocolo do gov-loop — PRÁXIS (Governança de Atendimento): leia
