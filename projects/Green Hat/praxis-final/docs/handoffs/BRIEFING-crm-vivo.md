...
- **Worktree:** `/Users/rafaelmelgaco/PRÁXIS-crm-vivo`
...
Existem outros worktrees vivos (`.claude/worktrees/*`, `PRÁXIS-qa`, `PRÁXIS-main-preview`,
`PRÁXIS-vendaval*`). **Nenhum deles é seu.** Trabalhe só no worktree acima.

---

## 1. A missão

O PRÁXIS existe para que **todo lead que entra vire uma venda feita ou um problema
