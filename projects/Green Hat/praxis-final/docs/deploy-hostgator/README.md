# Como subir o seu PRÁXIS na HostGator (passo a passo, sem enrolação)
...
```
Seu domínio  →  Servidor VPS (HostGator)  →  PRÁXIS rodando
                        │
                        ├─ o CRM (site + painel)
...
O PRÁXIS roda num **VPS com Docker**. A opção mais fácil é um VPS que **já vem
...
2. Escreva pra ele exatamente isto:
   ...
   > *"Clone https://github.com/melgarafael/PRÁXIS e me instale o PRÁXIS
...
O PRÁXIS foi desenhado pra rodar redondo na infraestrutura da HostGator. Além do
