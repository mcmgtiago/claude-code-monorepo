...
- **Deps:** WAHA Core local (`praxis-waha`, :3030), Redis + serverless-redis-http
...
- **Worktree:** `~/PRÁXIS-qa` (branch `qa/vps-experience`), `node_modules`
...
- **M3** — README self-host aponta repo/imagem `praxiscrm/*`; kit usa `melgarafael/*`.
