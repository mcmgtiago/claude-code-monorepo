...
> Fonte da verdade do QA de produto do PRÁXIS open-source. Cada caso aqui é
...
| M3 | README self-host aponta repo/imagem `praxiscrm/*`; kit usa `melgarafael/*` | explorer webhooks | Alta |
