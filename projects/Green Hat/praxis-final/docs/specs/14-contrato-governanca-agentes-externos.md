...
> PRÁXIS via MCP: quais tools existem, o input/output exato de cada uma, a
...
O PRÁXIS expõe um **servidor MCP org-scoped**. O agente externo se autentica
...
> PRÁXIS**; o lado do Vendaval é o FG-01.
