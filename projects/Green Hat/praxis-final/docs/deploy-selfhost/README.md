# PRÁXIS self-hosted — instalação em VPS (com agente de IA)
...
```bash
git clone https://github.com/praxiscrm/praxiscrm.git && cd praxiscrm
...
- **Backup diário** (do seu crontab na VPS):
  `0 3 * * * /caminho/repo/scripts/backup-db.sh /var/backups/praxis`
