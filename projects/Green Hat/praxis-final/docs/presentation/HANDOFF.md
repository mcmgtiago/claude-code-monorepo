...
- ✅ **Repositório no GitHub**: https://github.com/melgarafael/PRÁXIS
...
| **GitHub repo** | https://github.com/melgarafael/PRÁXIS (private) |
...
- **Memórias persistentes do projeto** em `~/.claude/projects/-Users-rafaelmelgaco-PRÁXIS/memory/`
  ...
  - `project_naming_and_timeline.md` — PRÁXIS, MVP-B 8-12 semanas
...
- Pitch deck pode ser renderizado com:
  ...
  ```
- GitHub repo: https://github.com/melgarafael/PRÁXIS (mostre as docs)
- Supabase Studio: dashboard.supabase.com → projeto PRÁXIS → Database → Tables (31 tabelas com RLS verde)
