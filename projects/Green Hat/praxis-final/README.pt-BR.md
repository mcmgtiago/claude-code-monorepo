...
# 🛠️ PRÁXIS — Sistema Operacional de Vendas com Agentes de IA
...
>
> O PRÁXIS foi desenvolvido em **parceria com a HostGator**: o [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
**Práxis** vem de **Desk** (mesa) + **comm** (comércio): **o comercial de mesa** — toda a operação de vendas do seu negócio numa mesa só, operada por pessoas e agentes de IA juntos.
...
Abra uma [issue](https://github.com/melgarafael/PRÁXIS/issues/new/choose) — o template pede o que precisamos (ambiente, `/api/v1/health`, steps).

Pra **vulnerabilidades de segurança**, **NÃO abra issue pública** — use o [relato privado de vulnerabilidades](https://github.com/melgarafael/PRÁXIS/security/advisories/new). Detalhes em [`SECURITY.md`](SECURITY.md).
...
- **MCP público** — capabilities do CRM expostas pro ecossistema de agentes: plugue o agente que quiser e ele opera o Práxis.
...
- **Discussões:** [GitHub Discussions](https://github.com/melgarafael/PRÁXIS/discussions) — pra perguntas, ideias, showcase.
- **Issues:** [GitHub Issues](https://github.com/melgarafael/PRÁXIS/issues) — bugs e tasks.
...
- **Suporte é comunitário e "as-is".** Dúvidas e bugs entram como
  [Issues](https://github.com/melgarafael/PRÁXIS/issues) ou
  [Discussions](https://github.com/melgarafael/PRÁXIS/discussions). Não há SLA nem
