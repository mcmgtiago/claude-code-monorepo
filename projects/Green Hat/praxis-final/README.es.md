...
# 🛠️ PRÁXIS — El Sistema Operativo de Ventas con Agentes de IA
...
>
> PRÁXIS se desarrolla en **alianza con HostGator**: el [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
**Práxis** viene de **Desk** (escritorio) + **comm** (comercio): toda la operación de ventas de tu negocio en un solo escritorio, operada por personas y agentes de IA trabajando juntos.
...
Abre un [issue](https://github.com/melgarafael/PRÁXIS/issues/new/choose) — la plantilla pide lo que necesitamos (entorno, `/api/v1/health`, pasos).

Para **vulnerabilidades de seguridad**, **NO abras un issue público** — usa el [reporte privado de vulnerabilidades](https://github.com/melgarafael/PRÁXIS/security/advisories/new). Detalles en [`SECURITY.md`](SECURITY.md).
...
- **MCP público** — capacidades del CRM expuestas al ecosistema de agentes: conecta el agente que quieras y opera Práxis.
...
- **Discusiones:** [GitHub Discussions](https://github.com/melgarafael/PRÁXIS/discussions)
...
- La comunidad que llevó Práxis del e-commerce a clínicas, inmobiliarias, infoproductos y más allá — ustedes definieron lo que este proyecto es.
