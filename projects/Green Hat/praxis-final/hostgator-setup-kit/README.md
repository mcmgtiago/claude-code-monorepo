# PRÁXIS — Kit de Instalação (HostGator)

Este kit sobe o **PRÁXIS** no seu servidor VPS da HostGator. Você tem dois caminhos:
...
3. Diga: *"instala o PRÁXIS pra mim"*. Ele lê o `CLAUDE.md` e conduz tudo —
