...
function createStore(filePath) {
  ...
  async function deleteContact(id) {
    return mutate((data) => {
      ...
      if (index === -1) throw new StoreError("Contato não encontrado.", 404);
      if (!data.contacts[index].optedIn) {
        throw new StoreError("Contatos descadastrados são mantidos na lista de supressão.");
      }
