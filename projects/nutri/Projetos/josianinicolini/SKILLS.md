# How to use the Josiane Nutri design system

Created from Open Design project "Instalar Caveman Code" (b86c3069-a856-42c5-a3ce-b67f0bc81abe).

This package is a portable **Project Design System** design system for websites, landing pages, dashboards, decks, and product UI. Hand the unzipped folder to any AI coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — alongside `DESIGN.md`, and it will produce on-brand work without further art direction.
