...
import {
  DndContext, DragOverlay, MouseSensor, TouchSensor, useDroppable, useDraggable, useSensor, useSensors,
...
function KanbanPage() {
  ...
  const sensors = useSensors(
    // Desktop: arrasta com 5px de movimento do mouse
    useSensor(MouseSensor, { activationConstraint: { distance: 5 } }),
    // Mobile: long-press (220ms) para arrastar — toque rápido continua rolando o kanban
