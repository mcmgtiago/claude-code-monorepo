...
const PLACEHOLDER = `Ex: I run a licensed flooring company in Miami, FL, serving Miami-Dade and Broward. We install hardwood ($8–$12/sq ft), LVP ($4–$6/sq ft), tile and do refinishing. Open Mon–Sat. I want the AI to greet new leads, ask what service they need and the square footage, give a price range, and offer a free in-home estimate — then book it on the calendar. Reply in the customer's language (EN/ES/PT).`;
...
function AgentePage() {
  ...
  const [testMsg, setTestMsg] = useState("Hi! Do you do hardwood floors? How much per sq ft?");
              ...
              <CollapsibleContent className="px-5 pb-5 space-y-4 border-t border-[var(--border)] pt-4">
                <div className="space-y-1.5">
                  ...
                  <Select value={tamanhoResposta} onValueChange={(v) => setTamanhoResposta(v as any)}>
                    ...
                    <SelectContent>
                      <SelectItem value="curtas">Curtas (estilo chat)</SelectItem>
