...
const sections = [
  {
    ...
    items: [
      ...
      // Cobrança desligada → Assinaturas escondida
      ...(BILLING_ENABLED ? [{ to: "/master/assinaturas", label: "Assinaturas", icon: CreditCard }] : []),
    ],
  },
  // Catálogo de planos só faz sentido com cobrança ligada
  ...(BILLING_ENABLED ? [{
    label: "Catálogo",
    items: [
