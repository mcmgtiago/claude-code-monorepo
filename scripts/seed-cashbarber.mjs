...
const CID = "9e63d0d3-b85e-47a2-9a1d-e0f529994d6e";
...
async function main() {
  ...
  const login = await fetch(`${SUPABASE_URL}/auth/v1/token?grant_type=password`, {
    ...
    body: JSON.stringify({ email: "junior@cashbarber.com.br", password: "Cash2026!" })
  }).then(r => r.json());
  ...
  console.log("\n=== CASHBARBER PRONTA ===");
  console.log("Login: junior@cashbarber.com.br / Cash2026!");
